				...
				>
					...
					<IonContent>
						{CrearItem(
							...
							(e) => {
								props.addChangedPuntuacion(puntuacion);
								puntuacion.puntuacionBasica.valoracion.estadistica = parseFloat(
									e.detail.value!
								);
						...
						{CrearItem(
							...
							(e) => {
								props.addChangedPuntuacion(puntuacion);
								puntuacion.puntuacionBasica.asistencias.estadistica = parseInt(
									e.detail.value!
								);
						...
						{CrearItem(
							...
							(e) => {
								props.addChangedPuntuacion(puntuacion);
								puntuacion.puntuacionOfensiva.tirosFuera.estadistica = parseInt(
									e.detail.value!
								);
						...
						{CrearItem(
							...
							(e) => {
								props.addChangedPuntuacion(puntuacion);
								puntuacion.puntuacionPosesion.pasesClave.estadistica = parseInt(
									e.detail.value!
								);
						...
						{CrearItem(
							...
							(e) => {
								...
								puntuacion.puntuacionPosesion.grandesOcasiones.puntos =
									getByTramos(puntuacionJSON.grandesOcasiones, e.detail.value!);
							}
						)}
						{CrearItem(
							j._id,
						...
						{CrearItem(
							...
							(e) => {
								props.addChangedPuntuacion(puntuacion);
								puntuacion.puntuacionDefensiva.despejes.estadistica = parseInt(
									e.detail.value!
								);
						...
						{CrearItem(
							...
							(e) => {
								props.addChangedPuntuacion(puntuacion);
								puntuacion.puntuacionDefensiva.entradas.estadistica = parseInt(
									e.detail.value!
								);
						...
						{CrearItem(
							...
							(e) => {
								...
								puntuacion.puntuacionFisico.faltasCometidas.puntos =
									getByTramos(puntuacionJSON.faltasCometidas, e.detail.value!);
							}
						)}
						{CrearItem(
							j._id,
							...
							(e) => {
								...
								puntuacion.puntuacionFisico.faltasRecibidas.puntos =
									getByTramos(puntuacionJSON.faltasRecibidas, e.detail.value!);
							}
						)}
						{CrearItem(
							j._id,
						...
						{CrearItem(
							...
							(e) => {
								...
								puntuacion.puntuacionFisico.posesionPerdida.puntos =
									getByTramos(puntuacionJSON.posesionPerdida, e.detail.value!);
							}
						)}
						{CrearItem(
							j._id,
